 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://ws.services.hotjoe.com/", wsdlLocation = "http://localhost:8080/sample/ProductService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://ws.services.hotjoe.com/", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/sample/ProductService?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://ws.services.hotjoe.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.services.hotjoe.com/", "ProductServicePort"), ProductService.class, features);
    }
